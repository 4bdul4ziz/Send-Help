...
String network = "testwifi";                            // access point's SSID
String password = "testwifipassword";                  // WiFi Access Point password
#define IP "184.106.153.149"                        // IP address of thingspeak.com
String GET = "GET /update?key=IUSAHF9OJFOAIFRA";    // channel key
